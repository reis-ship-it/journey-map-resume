...
const EDITOR_PASSCODE = "starter-passcode";
const STORAGE_KEY = "journey_map_resume_starter_v1";
...
const defaultEntries = [
  {
    ...
    locationDetail: "Public high school campus",
    lat: 30.2672,
    lng: -97.7431,
    description: "Completed secondary school and started mapping long-term interests across technology, communication, and creative problem solving.",
    overlapGroup: "Austin-Early-Foundation",
  },
  {
    id: crypto.randomUUID(),
    title: "University BA",
    ...
    location: "Chicago",
    country: "United States",
    locationDetail: "University campus",
    lat: 41.8781,
    lng: -87.6298,
    description: "Completed undergraduate studies with a focus on interdisciplinary problem solving, writing, and data-informed project work.",
    overlapGroup: "Chicago-Study-Track",
  },
  {
    id: crypto.randomUUID(),
    ...
    location: "Chicago",
    country: "United States",
    locationDetail: "Student organizations and peer mentorship",
    lat: 41.8781,
    lng: -87.6298,
    description: "Led orientation and peer-support initiatives while balancing coursework, building communication and group facilitation skills.",
    overlapGroup: "Chicago-Study-Track",
  },
  {
    id: crypto.randomUUID(),
    ...
    location: "Denver",
    country: "United States",
    locationDetail: "Retail + service operations",
    lat: 39.7392,
    lng: -104.9903,
    description: "Managed day-to-day operations, customer service, and process reliability in a fast-paced environment with shifting demand.",
    overlapGroup: "Denver-Operations",
  },
  {
    id: crypto.randomUUID(),
    ...
    location: "Remote",
    country: "United States",
    locationDetail: "Remote cohort-based program",
    lat: 39.8283,
    lng: -98.5795,
    description: "Built practical UX research, prototyping, and testing skills through project-based team sprints and critique cycles.",
    overlapGroup: "Denver-Operations",
  },
  {
    id: crypto.randomUUID(),
    ...
    location: "Atlanta",
    country: "United States",
    locationDetail: "Civic innovation lab",
    lat: 33.749,
    lng: -84.388,
    description: "Co-led a civic-facing project that turned community interviews into service improvements and measurable process changes.",
    overlapGroup: "Atlanta-Project-Arc",
  },
  {
    id: crypto.randomUUID(),
    title: "Creative Studio Freelance",
    startDate: "2023-02-01",
    endDate: "2024-08-31",
    category: "Work",
    location: "New York City",
    country: "United States",
    locationDetail: "Independent and studio collaborations",
    lat: 40.7128,
    lng: -74.006,
    description: "Delivered strategy and production support across brand, content, and digital launches with cross-functional collaborators.",
    overlapGroup: "NYC-Creative-Arc",
  },
  {
    id: crypto.randomUUID(),
    title: "Interactive Resume Map",
    startDate: "2026-01-05",
    endDate: "2026-01-06",
    category: "Project",
    location: "Remote",
    country: "United States",
    locationDetail: "Self-initiated build",
    lat: 39.8283,
    lng: -98.5795,
    description: "Designed and coded a map-based resume to show life, education, and work as a navigable story in time and place.",
    overlapGroup: "NYC-Creative-Arc",
  }
];
