...
const HITBOXES = {
  resume: { x: 0.18, y: 0.018, width: 0.29, height: 0.085 },
  portfolio: { x: 0.56, y: 0.018, width: 0.3, height: 0.085 },
  email: { x: 0.16, y: 0.79, width: 0.33, height: 0.055 },
  phone: { x: 0.62, y: 0.79, width: 0.23, height: 0.055 },
};
