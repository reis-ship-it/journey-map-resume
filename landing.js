...
const HITBOXES = {
  resume: { x: 0.295, y: -0.185, width: 0.245, height: 0.21 },
  portfolio: { x: 0.64, y: -0.185, width: 0.255, height: 0.21 },
  email: { x: 0.18, y: 0.46, width: 0.33, height: 0.105 },
  phone: { x: 0.76, y: 0.46, width: 0.23, height: 0.105 },
};
